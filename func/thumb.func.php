<?php
//this function was downloaded from phpacademy.org
function create_cover($directory, $image, $destination) {
  $image_file = $image;
...
function create_small_thumb($directory, $image, $destination) {
  $image_file = $image;
  $image = $directory.$image;
